...
For account-based editing, any source image must belong to your account. The generation button shows the credit cost; one click checks the prompt and current price before starting the job. You can also generate from text without a source image. New references uploaded in the signed-in editor are temporary: uploading enables submission, and clicking Generate starts the safety checks before the image model runs. These references expire after 24 hours and are removed through storage lifecycle rules, which may finish after the access deadline. Generated results remain available independently. Existing library media and generated outputs retain a 30-day target, with 7 days for failed-job cleanup. Keep your own copy of work you need for longer. Billing and security records can have different retention periods.
