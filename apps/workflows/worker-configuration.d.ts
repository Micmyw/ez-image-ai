/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a43faf850cab68bed363fb759eae8156)
// Runtime types generated with workerd@1.20260903.1 2026-09-08 nodejs_compat
interface __BaseEnv_Env {
	JOBS_RUNTIME: DurableObjectNamespace<import("./src/index").JobsContainer>;
	JOBS: Workflow<Parameters<import("./src/index").JobsWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "JobsContainer";
	}
