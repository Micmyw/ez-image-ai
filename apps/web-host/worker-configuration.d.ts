/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 817a0d80531cd8894939854bb508f662)
// Runtime types generated with workerd@1.20260903.1 2026-09-10 nodejs_compat
interface __BaseEnv_Env {
	CANONICAL_ORIGIN: "https://ezimageai-web-staging.15871497752myw.workers.dev" | "https://ezimageai.com" | "http://localhost:8787";
	SAAS: DurableObjectNamespace<import("./src/index").SaasContainer>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "SaasContainer";
	}
	interface StagingEnv {
		CANONICAL_ORIGIN: "https://ezimageai-web-staging.15871497752myw.workers.dev";
		SAAS: DurableObjectNamespace<import("./src/index").SaasContainer>;
	}
	interface ProductionEnv {
		CANONICAL_ORIGIN: "https://ezimageai.com";
		SAAS: DurableObjectNamespace<import("./src/index").SaasContainer>;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CANONICAL_ORIGIN">> {}
}
