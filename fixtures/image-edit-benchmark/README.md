...
input slots across the five required categories and three distinct synthetic edit task kinds per
slot (30 tasks total). Every source is a placeholder and every authorization status is pending. No
image file, license claim, private asset identifier, human rating, or Provider output is included.
...
4. keep at least ten inputs, at least three distinct task kinds per input, at least 30 tasks overall,
   and all five categories;
