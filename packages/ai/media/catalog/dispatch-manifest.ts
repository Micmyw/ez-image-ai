...
export const STATIC_DISPATCH_ROUTE_MANIFEST = [
	{
		...
		queueName: "media-image-kie-google_nano-banana",
	},
	{
		mediaKind: "image",
		provider: "kie",
		providerModelId: "gpt-image/1.5-text-to-image",
		taskId: "media-dispatch-image-kie-gpt-image_1.5-text-to-image",
		queueName: "media-image-kie-gpt-image_1.5-text-to-image",
	},
	{
		mediaKind: "image",
		provider: "kie",
		providerModelId: "gpt-image-2-text-to-image",
		taskId: "media-dispatch-image-kie-gpt-image-2-text-to-image",
		queueName: "media-image-kie-gpt-image-2-text-to-image",
	},
	{
		mediaKind: "image",
		provider: "kie",
		providerModelId: "gpt-image-2-5-flare-text-to-image",
		taskId: "media-dispatch-image-kie-gpt-image-2-5-flare-text-to-image",
		queueName: "media-image-kie-gpt-image-2-5-flare-text-to-image",
	},
	{
		mediaKind: "image",
		provider: "kie",
		providerModelId: "gpt-image-2-5-sunburst-text-to-image",
		taskId: "media-dispatch-image-kie-gpt-image-2-5-sunburst-text-to-image",
		queueName: "media-image-kie-gpt-image-2-5-sunburst-text-to-image",
	},
	{
		mediaKind: "image",
		provider: "kie",
		providerModelId: "bytedance/seedream-v4-text-to-image",
		taskId: "media-dispatch-image-kie-bytedance_seedream-v4-text-to-image",
		queueName: "media-image-kie-bytedance_seedream-v4-text-to-image",
	},
	{
		mediaKind: "image",
		provider: "kie",
		providerModelId: "seedream/4.5-text-to-image",
		taskId: "media-dispatch-image-kie-seedream_4.5-text-to-image",
		queueName: "media-image-kie-seedream_4.5-text-to-image",
	},
	{
		mediaKind: "image",
		provider: "kie",
		providerModelId: "seedream/5-lite-text-to-image",
		taskId: "media-dispatch-image-kie-seedream_5-lite-text-to-image",
		queueName: "media-image-kie-seedream_5-lite-text-to-image",
	},
	{
		mediaKind: "image",
		provider: "kie",
		providerModelId: "seedream/5-pro-text-to-image",
		taskId: "media-dispatch-image-kie-seedream_5-pro-text-to-image",
		queueName: "media-image-kie-seedream_5-pro-text-to-image",
	},
	{
		mediaKind: "image",
		provider: "replicate",
