...
ALTER TABLE "guest_link_intent" ADD CONSTRAINT "guest_link_intent_trialId_fkey" FOREIGN KEY ("trialId") REFERENCES "guest_media_trial"("id") ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE "guest_link_intent" ADD CONSTRAINT "guest_link_intent_registeredUserId_fkey" FOREIGN KEY ("registeredUserId") REFERENCES "user"("id") ON DELETE SET NULL ON UPDATE CASCADE;
